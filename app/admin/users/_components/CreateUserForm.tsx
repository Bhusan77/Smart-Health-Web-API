        ...
        >
            ...
            <div>
                ...
                <input
                    {...register("email")}
                    type="email"
                    className="h-10 w-full rounded-md border border-emerald-200 bg-emerald-50 px-3 text-sm outline-none focus:border-emerald-400"
            ...
            <div>
                <label className="text-sm font-medium text-sky-700">Confirm password</label>
                <input
